# Cedar Pollen BI — スギ雄花花芽量の都道府県別可視化

**公開サイト:** https://kafka2306.github.io/cedar-pollen-bi/

環境省が公開するスギ雄花花芽調査をもとに、都道府県別の花芽量を過去10年平均と比較して表示する公開データBIです。

このダッシュボードが扱うのは、花粉飛散予測の入力要因となる**スギ雄花の花芽量**です。空中を飛散した花粉の実測値、最終的な飛散予測値、医療上の症状リスクとは同一ではありません。
